...
2.1.2 Read AI_GUIDE.md (root overview)  
2.1.3 Read content/games/SPEC.md  
2.1.4 Read content/blog/SPEC.md  
2.1.5 Read all submodule SPEC.md files  
2.1.6 Read ai_skills/README.md  

### 2.2 Verify Core Rules Compliance
2.2.1 Check rule 2.1.1: No Chinese in AI files (AI_START.md, AI_GUIDE.md, ai_skills/*.md)  
...
2.4.2 Check AI_GUIDE.md file structure matches actual project structure  
